...
<link rel="stylesheet" href="${path}/js/lib/element-ui.min.css">
<link href="${path}/assets/scss/${cssPath==null?'index':cssPath}.css" rel="stylesheet">
<link href="${path}/js/lib/animate.min.css" rel="stylesheet">
<c:if test="${loading}">
    <link href="${path}/js/lib/preloader.min.css" rel="stylesheet">
</c:if>
